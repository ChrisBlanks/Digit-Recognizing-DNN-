...
Added a function that will prompt the user for NN information and abstract
duties away from the user. This function, start_up(), is called directly
...
def start_up():
    ...
    if user_setup == '':
        ...
        net = Hand_Alg_2.load(user_setup)
    
    u_choice1 = int(input('Do you want change the default evaluation data?\n'))
